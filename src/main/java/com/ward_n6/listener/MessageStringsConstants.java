...
public class MessageStringsConstants {
    public static String REPORT ="""
                                    ...
                                    1. /ID - указать id питомца (нужно узнать у волонтёра)
    ...
    public static String PERSONAL_DATA_REQUEST = """
                                ...
                                ПОСЛЕ РЕГИСТРАЦИИ ВВЕДИТЕ ИЛИ НАЖМИТЕ КОМАНДУ, ЧТОБЫ ЗАБРОНИРОВАТЬ ПИТОМЦА:
                                /takePet
                                """;
    ...
    public static String HOW_REPORT = """
                Для отчёта нужно отправить текст :memo: , описывающий: самочувствие питомца, рацион питания питомца, в каких условиях живёт питомец и фото :camera: питомца 
                        Для отправки отчёта нажмите или введите команду:
                        /report
                        """;
...
//            /photo
    ...
    public static String DOG_DESCRIPTION = "Здесь содержатся ~300 бездомных, потерянных или брошенных собак. Все привиты, чипированы и давно мечтают найти себе дом!\n"+
            " За годы работы мы нашли новый дом более чем для 7400 питомцев и хотим, чтобы на улицах не было бездомных животных.";
}
