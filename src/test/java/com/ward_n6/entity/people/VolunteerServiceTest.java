...
class VolunteerServiceTest {
    ...
    private final OwnerReport ownerReport1 = new OwnerReport(11L, 2L, 2L,LocalDateTime.now().minusDays(1),
            PetsType.DOG,false,"nutrition","health", "behavior");
    private final OwnerReport ownerReport2 = new OwnerReport(12L, 21L,3L, LocalDateTime.now(), PetsType.CAT,
